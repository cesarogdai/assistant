...
def sendEmail(to, content):
    ...
    server.login("cesarogdai01@gmail.com", "cf113207")
    server.sendmail('cf113207',to, content)
    server.close()
    ...
    while True:
        ...
        if 'time' in query:
            ...
            if(confirm in 'yes' or 'correct'):
                account_sid = 'AC2535121f68448a537fc4da6e38d5aeb5'
                auth_token = '9b7dee43ec9c7ff6f7478ed3a2282354'
